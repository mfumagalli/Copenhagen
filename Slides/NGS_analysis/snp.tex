...
\frame{\frametitle{Estimating allele frequencies}
...
\frame{\frametitle{Estimating allele frequencies}
	...
	\end{center}
    	...
    	\begin{equation*}
		\hat{n_A} = \sum_{i=1}^N (1-\epsilon)n_{A,i} + \epsilon n_{G,i} - \epsilon n_{A,i} - (1-\epsilon)n_{G,i} = 0.77
	\end{equation*}
...
\frame{
\frametitle{SNP calling (for low-coverage NGS data)}
	...
	\begin{block}{How to call SNPs (traditionally)?}
	\begin{itemize}
...
\frame{\frametitle{SNP calling procedures}
...
\frame{\frametitle{Likelihood Ratio Test}
